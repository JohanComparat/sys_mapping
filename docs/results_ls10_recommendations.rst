...
.. csv-table::
   ...
   "9.0", "32", "0.0698", "0.020 (NSIDE 32)", "``WEIGHT_SYS``", "the NSIDE 32 likelihood ratio requires the multiplicative term (p = 0.020)"
   ...
   "11.25", "64", "0.0050", "0.020 (NSIDE 64)", "``WEIGHT_SYS``", "a template is detected (family-wise p 0.0050) and the NSIDE 64 likelihood ratio requires the multiplicative term (p = 0.020)"
   "11.5", "16", "0.9002", "0.020 (NSIDE 32)", "``WEIGHT_SYS``", "the NSIDE 32 likelihood ratio requires the multiplicative term (p = 0.020)"
