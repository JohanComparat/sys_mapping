...
.. figure:: /_static/results_sim_null_test/BIN_4/01_snr_distribution.png
   :width: 90%
...
.. figure:: /_static/results_sim_null_test/BIN_4/02_max_snr_per_sim.png
   :width: 90%

   Max \|SNR\| per simulation (sorted). Simulations above the dashed
   3σ line are false detections.

.. figure:: /_static/results_sim_null_test/BIN_4/03_twopcf_ratios.png
   :width: 90%

   Two-point function correction ratios (w_corr / w_obs) at 10' and
   200'. Ideal value: 1.0 — no correction needed.

.. figure:: /_static/results_sim_null_test/BIN_4/04_weight_deviation.png
   :width: 90%
